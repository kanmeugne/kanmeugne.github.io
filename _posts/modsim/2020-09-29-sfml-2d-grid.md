...
The most important features of our 2D grid are defined the interface *IGrid*, realized by the *Grid* object (see **Fig.4**).

A *Grid* object is basically composed of grid cells each one of them described as a *IGrid::CELL* object. The main methods are listed as follows :
